...
import 'package:flutterbook/utils.dart' show toFormattedDate;
  ...
  Future _deleteTask(BuildContext context, Task note) {
    return showDialog(
        ...
        builder: (BuildContext alertContext) {
          return AlertDialog(title: Text('Delete Task'), content: Text('Really delete ${note.description}?'), actions: [
            FlatButton(
              child: Text('Cancel'),
              onPressed: () {
