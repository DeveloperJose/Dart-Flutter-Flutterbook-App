...
class AppointmentsList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (Appointment app in appointmentsModel.entityList) {
      ...
      markedDateMap.add(date, Event(date: date, icon: Container(decoration: BoxDecoration(color: Colors.black))));
    }
          ...
          return Scaffold(
            floatingActionButton: FloatingActionButton(
                ...
                onPressed: () async {
                  ...
                  appointmentsModel.entityBeingEdited.date = "${now.year},${now.month},${now.day}";
  ...
  Future _deleteAppointment(BuildContext context, Appointment app) {
    return showDialog(
        ...
        builder: (BuildContext alertContext) {
          return AlertDialog(title: Text('Delete Appointment'), content: Text('Really delete ${app.title}?'), actions: [
            FlatButton(
              child: Text('Cancel'),
              onPressed: () {
